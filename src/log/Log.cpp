...
void Log::message(std::string message) {
    ...
    if (Log::level >= 2)
        std::cout << withColor(msg.str(), LogColor::Yellow) << std::endl;
}
...
void Log::success(std::string message) {
    ...
    if (Log::level >= 1)
        std::cout << withColor(msg.str(), LogColor::Green) << std::endl;
}
...
void Log::info(std::string message) {
    ...
    if (Log::level >= 3)
        std::cout << withColor(msg.str(), LogColor::Blue) << std::endl;
}
